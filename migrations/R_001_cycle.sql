...
insert into cycle (name, label, ord, indicators) values
  ...
  ('fully_integrated', 'Fully Integrated', 4, array['Communication unmediated by framework awareness', 'Engagement present without self-monitoring', 'Framework operates as cognitive integration', 'Impulses detected without generating pressure', 'Observations indistinguishable from thinking during formulation']);
